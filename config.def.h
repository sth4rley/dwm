...
static char normfgcolor[]                = "#a5a5a5";	  // fg -> ws inativo e widgets
static char normbgcolor[]                = "#202020"; // bg -> ws inativo e widgets
static char normbordercolor[]            = "#404040";
static char normfloatcolor[]             = "#db8fd9";

static char selfgcolor[]                 = "#d5d5d5";    // fg -> titulo e ws ativo
static char selbgcolor[]                 = "#303030"; // bg -> titulo e ws ativo
static char selbordercolor[]             = "#303030"; // bg -> titulo e ws ativo
static char selfloatcolor[]              = "#303030"; // bg -> titulo e ws ativo

static char titlenormfgcolor[]           = "#a5a5a5";    // fg -> ws inativo e widgets
static char titlenormbgcolor[]           = "#202020"; // bg -> ws inativo e widgets
static char titlenormbordercolor[]       = "#404040";
static char titlenormfloatcolor[]        = "#db8fd9";

static char titleselfgcolor[]            = "#d5d5d5";    // fg -> titulo e ws ativo
static char titleselbgcolor[]            = "#303030"; // bg -> titulo e ws ativo
static char titleselbordercolor[]        = "#303030"; // bg -> titulo e ws ativo
static char titleselfloatcolor[]         = "#303030"; // bg -> titulo e ws ativo

static char tagsnormfgcolor[]            = "#a5a5a5";    // fg -> ws inativo e widgets
static char tagsnormbgcolor[]            = "#202020"; // bg -> ws inativo e widgets
static char tagsnormbordercolor[]        = "#404040";
static char tagsnormfloatcolor[]         = "#db8fd9";

static char tagsselfgcolor[]             = "#d5d5d5";    // fg -> titulo e ws ativo
static char tagsselbgcolor[]             = "#303030"; // bg -> titulo e ws ativo 
static char tagsselbordercolor[]         = "#303030"; // bg -> titulo e ws ativo
static char tagsselfloatcolor[]          = "#303030"; // bg -> titulo e ws ativo

static char hidnormfgcolor[]             = "#303030";
static char hidselfgcolor[]              = "#227799";
static char hidnormbgcolor[]             = "#202020"; // bg -> ws inativo e widgets
static char hidselbgcolor[]              = "#202020"; // bg -> ws inativo e widgets

static char urgfgcolor[]                 = "#a5a5a5";
...
#endif // NAMETAG_PATCH
{
	...
	[DEFAULT_TAGS]        = { "Web", "Term", "Vim", "Music", "Other"},
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_p,          spawn,                  SHCMD("light -A 5") },
